...
#define INCLUDED_arrow_ext_lambda_FilterThunk
...
class FilterThunk_obj : public arrow::AsyncArrow_obj
{
	public:
	...
	public:
		static hxObjectPtr<FilterThunk_obj > __new(Dynamic $t1,Dynamic $t2,Dynamic $t3);
		...
		String __ToString() const { return String(L"FilterThunk",11); }
...
#endif /* INCLUDED_arrow_ext_lambda_FilterThunk */ 
