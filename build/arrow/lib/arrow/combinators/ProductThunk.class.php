...
class arrow_combinators_ProductThunk extends arrow_AsyncArrow {
	public function __construct($f, $g) { if( !php_Boot::$skip_constructor ) {
		...
		parent::__construct(array(new _hx_lambda(array("f" => &$f, "g" => &$g, "self" => &$self), null, array('x','a'), "{
			...
			\$debug = arrow_AsyncArrow::tuple(array(new _hx_lambda(array(\"a\" => &\$a, \"barrier\" => &\$barrier, \"cancel\" => &\$cancel, \"count\" => &\$count, \"debug\" => &\$debug, \"f\" => &\$f, \"first\" => &\$first, \"g\" => &\$g, \"second\" => &\$second, \"self\" => &\$self, \"x\" => &\$x, \"y1\" => &\$y1, \"y2\" => &\$y2), null, array('x1'), \"{
				return \\\$x1;
			}\"), 'execute1'));
			\$f1 = arrow_AsyncArrow::tuple(array(new _hx_lambda(array(\"a\" => &\$a, \"barrier\" => &\$barrier, \"cancel\" => &\$cancel, \"count\" => &\$count, \"debug\" => &\$debug, \"f\" => &\$f, \"f1\" => &\$f1, \"first\" => &\$first, \"g\" => &\$g, \"second\" => &\$second, \"self\" => &\$self, \"x\" => &\$x, \"y1\" => &\$y1, \"y2\" => &\$y2), null, array('y'), \"{
				\\\$y1 = \\\$y;
				call_user_func_array(\\\$barrier, array());
			}\"), 'execute1'));
			\$g1 = arrow_AsyncArrow::tuple(array(new _hx_lambda(array(\"a\" => &\$a, \"barrier\" => &\$barrier, \"cancel\" => &\$cancel, \"count\" => &\$count, \"debug\" => &\$debug, \"f\" => &\$f, \"f1\" => &\$f1, \"first\" => &\$first, \"g\" => &\$g, \"g1\" => &\$g1, \"second\" => &\$second, \"self\" => &\$self, \"x\" => &\$x, \"y1\" => &\$y1, \"y2\" => &\$y2), null, array('y'), \"{
				\\\$y2 = \\\$y;
				call_user_func_array(\\\$barrier, array());
			}\"), 'execute1'));
