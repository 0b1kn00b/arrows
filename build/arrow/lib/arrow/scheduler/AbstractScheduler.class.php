...
class arrow_scheduler_AbstractScheduler implements arrow_scheduler_Scheduler{
	...
	public function dispatch() {
		...
		while(($m = $this->activationQueue->dequeue()) !== null) {
			...
			{ $e = $_ex_;
			{
				haxe_Log::trace("command error =" . $m . " ::" . $e, _hx_anonymous(array("fileName" => "AbstractScheduler.hx", "lineNumber" => 24, "className" => "arrow.scheduler.AbstractScheduler", "methodName" => "dispatch")));
			}}}
			unset($e,$_ex_,$__e__);
		}
	}
