...
class util_MathUtil {
	...
	static function isOdd($value) {
		return eval("if(isset(\$this)) \$__this =& \$this;\$tmp = \$value % 2;
			\$__r__ = (Std::is(\$tmp, _hx_qtype(\"Bool\")) ? \$tmp : eval(\"if(isset(\\\$this)) \\\$__this =& \\\$this;throw new HException(\\\"Class cast error\\\");
				return \\\$__r__2;
			\"));
			return \$__r__;
		");
