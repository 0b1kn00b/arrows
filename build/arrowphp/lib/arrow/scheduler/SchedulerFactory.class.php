...
class arrow_scheduler_SchedulerFactory extends core_AbstractLocator {
	...
	static function create($type) {
		...
		case 0:
		{
			$s = new arrow_scheduler_AbstractScheduler(arrow_scheduler_SchedulerFactory::$maxMessages);
		}break;
		}
		return $s;
	}
	...
	static function run() {
		arrow_scheduler_AbstractScheduler::yield(arrow_scheduler_SchedulerFactory::getDefault());
	}
