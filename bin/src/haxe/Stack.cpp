...
Array< ::haxe::StackItem > Stack_obj::callStack( ){
	...
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/haxe/Stack.hx",60)
...
Array< ::haxe::StackItem > Stack_obj::exceptionStack( ){
	...
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/haxe/Stack.hx",93)
	return Array_obj< ::haxe::StackItem >::__new();
}
...
::String Stack_obj::toString( Array< ::haxe::StackItem > stack){
	...
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/haxe/Stack.hx",101)
	::StringBuf b = ::StringBuf_obj::__new();
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/haxe/Stack.hx",102)
	{
		HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/haxe/Stack.hx",102)
		int _g = 0;
		HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/haxe/Stack.hx",102)
		while((_g < stack->length)){
			...
			HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/haxe/Stack.hx",102)
			++(_g);
			HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/haxe/Stack.hx",103)
			b->b[b->b->length] = HX_CSTRING("\nCalled from ");
			HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/haxe/Stack.hx",104)
			::haxe::Stack_obj::itemToString(b,s);
		}
	}
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/haxe/Stack.hx",106)
...
Void Stack_obj::itemToString( ::StringBuf b,::haxe::StackItem s){
{
		...
		HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/haxe/Stack.hx",110)
		::haxe::StackItem _switch_1 = (s);
		switch((_switch_1)->GetIndex()){
			case 0: {
				HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/haxe/Stack.hx",112)
...
{
					HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/haxe/Stack.hx",114)
					b->b[b->b->length] = HX_CSTRING("module ");
					HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/haxe/Stack.hx",115)
					b->b[b->b->length] = m;
				}
			}
			;break;
...
{
					HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/haxe/Stack.hx",117)
					if ((s1 != null())){
						HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/haxe/Stack.hx",118)
						::haxe::Stack_obj::itemToString(b,s1);
						HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/haxe/Stack.hx",119)
						b->b[b->b->length] = HX_CSTRING(" (");
					}
					HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/haxe/Stack.hx",121)
					b->b[b->b->length] = file;
					HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/haxe/Stack.hx",122)
					b->b[b->b->length] = HX_CSTRING(" line ");
					HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/haxe/Stack.hx",123)
					b->b[b->b->length] = line;
					HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/haxe/Stack.hx",124)
					if ((s1 != null()))
						b->b[b->b->length] = HX_CSTRING(")");
				}
			}
...
{
					HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/haxe/Stack.hx",126)
					b->b[b->b->length] = cname;
					HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/haxe/Stack.hx",127)
					b->b[b->b->length] = HX_CSTRING(".");
					HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/haxe/Stack.hx",128)
					b->b[b->b->length] = meth;
				}
			}
			;break;
...
{
					HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/haxe/Stack.hx",130)
					b->b[b->b->length] = HX_CSTRING("local function #");
					HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/haxe/Stack.hx",131)
					b->b[b->b->length] = n;
				}
			}
			;break;
...
Dynamic Stack_obj::makeStack( Dynamic s){
	...
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/haxe/Stack.hx",190)
	return null();
}
