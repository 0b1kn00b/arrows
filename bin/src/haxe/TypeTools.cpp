...
::List TypeTools_obj::getClassNames( Dynamic value){
	...
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/haxe/TypeTools.hx",41)
	::List result = ::List_obj::__new();
	struct _Function_1_1{
		inline static Dynamic Block( Dynamic &value){
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/haxe/TypeTools.hx",46)
			return value;
		}
	};
	struct _Function_1_2{
		inline static ::Class Block( Dynamic &value){
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/haxe/TypeTools.hx",49)
			return ::Type_obj::getClass(value);
		}
	};
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/haxe/TypeTools.hx",43)
	::Class valueClass = (  (::Std_obj::is(value,hx::ClassOf< ::Class >())) ? ::Class(_Function_1_1::Block(value)) : ::Class(_Function_1_2::Block(value)) );
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/haxe/TypeTools.hx",52)
	while((null() != valueClass)){
		__SAFE_POINT
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/haxe/TypeTools.hx",53)
		result->add(::Type_obj::getClassName(valueClass));
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/haxe/TypeTools.hx",54)
		valueClass = ::Type_obj::getSuperClass(valueClass);
	}
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/haxe/TypeTools.hx",56)
	return result;
}
