...
{
{
	HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",21)
	super::__construct();
}
;
	return null();
...
Dynamic ComplexTest_obj::debug( Dynamic x){
	...
	HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",24)
	::haxe::Log_obj::trace((HX_CSTRING("result = ") + x),hx::SourceInfo(HX_CSTRING("ComplexTest.hx"),24,HX_CSTRING("haxe.reactive.arrow.ComplexTest"),HX_CSTRING("debug")));
	HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",25)
	return x;
}
...
{
				__SAFE_POINT
				HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",31)
				::haxe::test::Assert_obj::equals(HX_CSTRING("g"),x,null(),null(),hx::SourceInfo(HX_CSTRING("ComplexTest.hx"),31,HX_CSTRING("haxe.reactive.arrow.ComplexTest"),HX_CSTRING("testOr")));
				HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",32)
				return x;
			}
			return null();
		}
		...
		HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",29)
...
{
				HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",36)
				return HX_CSTRING("f");
			}
			return null();
		}
		...
		HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",35)
		Dynamic f =  Dynamic(new _Function_1_2());

		HX_BEGIN_LOCAL_FUNC0(_Function_1_3)
		::String run(Dynamic x){
{
				HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",39)
				return HX_CSTRING("g");
			}
			return null();
		}
		...
		HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",38)
		Dynamic g =  Dynamic(new _Function_1_3());
		HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",42)
		...
		HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",43)
		...
		HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",44)
...
Void ComplexTest_obj::testRepeat( ){
{
		...
		HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",48)
...
{
				__SAFE_POINT
				HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",51)
				::haxe::test::Assert_obj::isTrue(true,null(),hx::SourceInfo(HX_CSTRING("ComplexTest.hx"),51,HX_CSTRING("haxe.reactive.arrow.ComplexTest"),HX_CSTRING("testRepeat")));
			}
			return null();
		}
		HX_END_LOCAL_FUNC1((void))

		HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",49)
...
{
				__SAFE_POINT
				HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",55)
				(count[0])++;
				HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",56)
				if ((count->__get(0) < 10)){
					HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",57)
					return ::haxe::functional::arrows::Arrow_obj::doRepeat(null());
				}
				else{
					HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",59)
		...
		HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",54)
...
Void ComplexTest_obj::testAnimate( ){
{
		...
		HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",66)
		double t = ::haxe::Timer_obj::stamp();
		HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",67)
...
{
				__SAFE_POINT
				HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",71)
				::haxe::test::Assert_obj::isTrue((::haxe::Timer_obj::stamp() > t1->__get(0)),null(),hx::SourceInfo(HX_CSTRING("ComplexTest.hx"),71,HX_CSTRING("haxe.reactive.arrow.ComplexTest"),HX_CSTRING("testAnimate")));
			}
			return null();
		}
		HX_END_LOCAL_FUNC1((void))

		HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",69)
...
{
				__SAFE_POINT
				HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",76)
				if ((::haxe::Timer_obj::stamp() < t1->__get(0))){
					HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",77)
					return ::haxe::functional::arrows::Arrow_obj::doRepeat(x);
				}
				else{
					HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",79)
		...
		HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",75)
...
Void ComplexTest_obj::testIndependentLoop( ){
{
		...
		HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",85)
		Array< int > arr = Array_obj< int >::__new();
		HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",86)
		Array< int > arr2 = Array_obj< int >::__new();
		HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",87)
		Array< Array< int > > comp = Array_obj< Array< int > >::__new().Add(Array_obj< int >::__new());
		HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",88)
		{
			HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",88)
			int _g = 0;
			HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",88)
			while((_g < 5)){
				...
				HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",88)
				int i = (_g)++;
				HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",89)
				arr->push(i);
				HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",90)
				arr2->push(i);
			}
		}
		HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",92)
		::haxe::reactive::arrow::ComplexTest self = this;

		HX_BEGIN_LOCAL_FUNC1(_Function_1_1,Array< Array< int > >,comp)
		Void run(Dynamic x){
{
				__SAFE_POINT
				HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",95)
				comp[0]->push(x);
			}
			return null();
		}
		...
		HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",93)
		...
		HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",98)
...
{
				__SAFE_POINT
				HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",101)
				comp[0]->push(x);
			}
			return null();
		}
		...
		HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",99)
...
{
				__SAFE_POINT
				HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",106)
				::haxe::test::Assert_obj::equals(Array_obj< int >::__new().Add(0).Add(0).Add(1).Add(1).Add(2).Add(2).Add(3).Add(3).Add(4).Add(4),comp->__get(0),null(),null(),hx::SourceInfo(HX_CSTRING("ComplexTest.hx"),106,HX_CSTRING("haxe.reactive.arrow.ComplexTest"),HX_CSTRING("testIndependentLoop")));
			}
			return null();
		}
		HX_END_LOCAL_FUNC1((void))

		HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",104)
		Dynamic as = ::haxe::test::Assert_obj::createEvent( Dynamic(new _Function_1_3(comp)),null());
		HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",109)
		b->info = HX_CSTRING("show count b");
		HX_SOURCE_POS("unit/haxe/reactive/arrow/ComplexTest.hx",110)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("haxe.reactive.arrow.ComplexTest"), hx::TCanCast< ComplexTest_obj> ,sStaticFields,sMemberFields,
