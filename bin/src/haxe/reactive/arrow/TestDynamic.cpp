...
Dynamic TestDynamic_obj::resolve( Dynamic key){
	...
	HX_SOURCE_POS("unit/haxe/reactive/arrow/ArrowTest.hx",149)
	return ::haxe::reactive::arrow::TestDynamicFunctionSource_obj::__new()->whatAmI;
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("haxe.reactive.arrow.TestDynamic"), hx::TCanCast< TestDynamic_obj> ,sStaticFields,sMemberFields,
