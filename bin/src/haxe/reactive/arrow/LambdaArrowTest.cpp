...
{
{
	HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",17)
	super::__construct();
}
;
	return null();
...
Void LambdaArrowTest_obj::testMap( ){
{
		...
		HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",20)
		::haxe::reactive::arrow::LambdaArrowTest self = this;
		HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",21)
		int count = 0;
...
{
				__SAFE_POINT
				HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",24)
				Array< int > a = Array_obj< int >::__new().Add(1).Add(2).Add(3);
				HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",25)
				Array< int > b = ::Lambda_obj::array(x);
				HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",26)
				{
					HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",26)
					int _g1 = 0;
					int _g = a->length;
					...
					while((_g1 < _g)){
						...
						HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",26)
						int i = (_g1)++;
						HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",27)
						::haxe::test::Assert_obj::equals(a->__get(i),b->__get(i),null(),null(),hx::SourceInfo(HX_CSTRING("LambdaArrowTest.hx"),27,HX_CSTRING("haxe.reactive.arrow.LambdaArrowTest"),HX_CSTRING("testMap")));
					}
				}
			}
			return null();
		...
		HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",22)
		...
		int run(Dynamic x){
{
				struct _Function_2_1{
					inline static int Block( Dynamic &x){
						HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",35)
						Dynamic _switch_1 = (x);
						if (  ( _switch_1==HX_CSTRING("a"))){
							HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",36)
							return 1;
						}
						else if (  ( _switch_1==HX_CSTRING("b"))){
							HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",37)
							return 2;
						}
						else if (  ( _switch_1==HX_CSTRING("c"))){
							HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",38)
							return 3;
						}
						else  {
							HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",35)
...
;
		...
		HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",33)
		...
		HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",42)
...
Void LambdaArrowTest_obj::testIter( ){
{
		...
		HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",45)
		::haxe::reactive::arrow::LambdaArrowTest self = this;
		HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",46)
		Array< int > a = Array_obj< int >::__new().Add(0);
		HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",47)
...
{
				__SAFE_POINT
				HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",51)
				::haxe::test::Assert_obj::equals(6,a->__get(0),null(),null(),hx::SourceInfo(HX_CSTRING("LambdaArrowTest.hx"),51,HX_CSTRING("haxe.reactive.arrow.LambdaArrowTest"),HX_CSTRING("testIter")));
			}
			return null();
		}
		HX_END_LOCAL_FUNC1((void))

		HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",49)
		...
		Void run(int x){
{
				HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",56)
				hx::AddEq(a[0],x);
			}
			return null();
		}
		...
		HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",54)
...
Void LambdaArrowTest_obj::testFilter( ){
{
		...
		HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",61)
		Array< ::haxe::reactive::arrow::LambdaArrowTest > self = Array_obj< ::haxe::reactive::arrow::LambdaArrowTest >::__new().Add(this);

		HX_BEGIN_LOCAL_FUNC1(_Function_1_1,Array< ::haxe::reactive::arrow::LambdaArrowTest >,self)
		Void run(Dynamic x){
{
				__SAFE_POINT
				HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",64)
				self[0]->assertTrue((::Lambda_obj::count(x) == 1),null(),hx::SourceInfo(HX_CSTRING("LambdaArrowTest.hx"),64,HX_CSTRING("haxe.reactive.arrow.LambdaArrowTest"),HX_CSTRING("testFilter")));
			}
			return null();
		}
		HX_END_LOCAL_FUNC1((void))

		HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",62)
		Dynamic as = ::haxe::test::Assert_obj::createEvent( Dynamic(new _Function_1_1(self)),null());

		HX_BEGIN_LOCAL_FUNC0(_Function_1_2)
		bool run(int x){
{
				HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",69)
				return (x == 1);
			}
			return null();
		}
		...
		HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",67)
...
Void LambdaArrowTest_obj::testLong( ){
{
		...
		HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",74)
		Array< ::haxe::reactive::arrow::LambdaArrowTest > self = Array_obj< ::haxe::reactive::arrow::LambdaArrowTest >::__new().Add(this);
...
{
				__SAFE_POINT
				HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",77)
				self[0]->assertTrue(true,null(),hx::SourceInfo(HX_CSTRING("LambdaArrowTest.hx"),77,HX_CSTRING("haxe.reactive.arrow.LambdaArrowTest"),HX_CSTRING("testLong")));
			}
			return null();
		}
		HX_END_LOCAL_FUNC1((void))

		HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",75)
		Dynamic as = ::haxe::test::Assert_obj::createEvent( Dynamic(new _Function_1_1(self)),60000);
		HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",80)
		::List list = ::List_obj::__new();
		HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",82)
		{
			HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",82)
			int _g = 0;
			HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",82)
			while((_g < 10000)){
				...
				HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",82)
				int i = (_g)++;
				HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",83)
		...
		double run(double x){
{
				HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",87)
				double a = (x + (double(1) / double(2)));
				HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",88)
				double b = (87984 + 134123412233);
				HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",89)
				double c = (a + b);
				HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",90)
				return c;
			}
			return null();
		}
		...
		HX_SOURCE_POS("unit/haxe/reactive/arrow/LambdaArrowTest.hx",85)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("haxe.reactive.arrow.LambdaArrowTest"), hx::TCanCast< LambdaArrowTest_obj> ,sStaticFields,sMemberFields,
