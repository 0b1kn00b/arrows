...
#endif
#ifndef INCLUDED_haxe_reactive_arrow_ErrorTest
...
{
{
	HX_SOURCE_POS("unit/haxe/reactive/arrow/ErrorTest.hx",12)
	super::__construct();
}
;
	return null();
...
Void ErrorTest_obj::testParameterMismatchNumberError_ExpectOneReceiveZero( ){
{
		...
		HX_SOURCE_POS("unit/haxe/reactive/arrow/ErrorTest.hx",15)
...
Void ErrorTest_obj::testParameterMismatchNumberError_ExpectZeroReceiveOne( ){
{
		...
		HX_SOURCE_POS("unit/haxe/reactive/arrow/ErrorTest.hx",18)
...
Dynamic ErrorTest_obj::f0( Dynamic x){
	...
	HX_SOURCE_POS("unit/haxe/reactive/arrow/ErrorTest.hx",21)
	return x;
}
...
::haxe::functional::arrows::Arrow ErrorTest_obj::simpleAssert( ){
	...
	HX_SOURCE_POS("unit/haxe/reactive/arrow/ErrorTest.hx",26)
	Array< ::haxe::reactive::arrow::ErrorTest > self = Array_obj< ::haxe::reactive::arrow::ErrorTest >::__new().Add(this);

	HX_BEGIN_LOCAL_FUNC1(_Function_1_1,Array< ::haxe::reactive::arrow::ErrorTest >,self)
	Void run(Dynamic x){
{
			__SAFE_POINT
			HX_SOURCE_POS("unit/haxe/reactive/arrow/ErrorTest.hx",29)
			self[0]->assertTrue(true,null(),hx::SourceInfo(HX_CSTRING("ErrorTest.hx"),29,HX_CSTRING("haxe.reactive.arrow.ErrorTest"),HX_CSTRING("simpleAssert")));
		}
		return null();
	}
	HX_END_LOCAL_FUNC1((void))

	HX_SOURCE_POS("unit/haxe/reactive/arrow/ErrorTest.hx",27)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("haxe.reactive.arrow.ErrorTest"), hx::TCanCast< ErrorTest_obj> ,sStaticFields,sMemberFields,
