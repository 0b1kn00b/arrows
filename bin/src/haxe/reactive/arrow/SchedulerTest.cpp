...
#endif
#ifndef INCLUDED_haxe_reactive_arrow_SchedulerTest
...
{
{
	HX_SOURCE_POS("unit/haxe/reactive/arrow/SchedulerTest.hx",15)
	super::__construct();
}
;
	return null();
...
Void SchedulerTest_obj::testSimpleCancel( ){
{
		...
		HX_SOURCE_POS("unit/haxe/reactive/arrow/SchedulerTest.hx",18)
...
{
				__SAFE_POINT
				HX_SOURCE_POS("unit/haxe/reactive/arrow/SchedulerTest.hx",22)
				::haxe::test::Assert_obj::isTrue((::haxe::functional::arrows::schedule::ScheduleManager_obj::getInstance()->buffer->getLength() == 0),null(),hx::SourceInfo(HX_CSTRING("SchedulerTest.hx"),22,HX_CSTRING("haxe.reactive.arrow.SchedulerTest"),HX_CSTRING("testSimpleCancel")));
			}
			return null();
		}
		HX_END_LOCAL_FUNC0((void))

		HX_SOURCE_POS("unit/haxe/reactive/arrow/SchedulerTest.hx",20)
		Dynamic a = ::haxe::test::Assert_obj::createAsync( Dynamic(new _Function_1_1()),null());
		HX_SOURCE_POS("unit/haxe/reactive/arrow/SchedulerTest.hx",27)
		arr = ::haxe::functional::arrows::Arrow_obj::returnA()->run(null());
		HX_SOURCE_POS("unit/haxe/reactive/arrow/SchedulerTest.hx",29)
		hx::TCast< haxe::functional::arrows::combinators::ProgressArrow >::cast(arr)->cancel();
		HX_SOURCE_POS("unit/haxe/reactive/arrow/SchedulerTest.hx",30)
		a();
	}
return null();
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("haxe.reactive.arrow.SchedulerTest"), hx::TCanCast< SchedulerTest_obj> ,sStaticFields,sMemberFields,
