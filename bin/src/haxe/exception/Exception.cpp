...
{
{
	struct _Function_1_1{
		inline static ::String Block( ::String &message){
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/haxe/exception/Exception.hx",66)
			return message;
		}
	};
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/haxe/exception/Exception.hx",62)
	this->message = (  ((null() == message)) ? ::String(HX_CSTRING("Unknown exception")) : ::String(_Function_1_1::Block(message)) );
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/haxe/exception/Exception.hx",68)
	this->innerException = innerException;
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/haxe/exception/Exception.hx",69)
	{
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/haxe/exception/Exception.hx",69)
	...
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/haxe/exception/Exception.hx",70)
...
Void Exception_obj::generateStackTrace( int numberOfStackTraceShifts){
{
		...
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/haxe/exception/Exception.hx",79)
		this->stackTraceArray = ::haxe::Stack_obj::callStack()->slice((numberOfStackTraceShifts + 1),null());
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/haxe/exception/Exception.hx",81)
		::Class exceptionClass = ::Type_obj::getClass(this);
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/haxe/exception/Exception.hx",82)
		while((hx::ClassOf< ::haxe::exception::Exception >() != exceptionClass)){
			__SAFE_POINT
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/haxe/exception/Exception.hx",83)
			this->stackTraceArray->shift();
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/haxe/exception/Exception.hx",84)
			exceptionClass = ::Type_obj::getSuperClass(exceptionClass);
		}
	}
return null();
...
::haxe::exception::Exception Exception_obj::getBaseException( ){
	...
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/haxe/exception/Exception.hx",91)
	::haxe::exception::Exception result = this;
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/haxe/exception/Exception.hx",92)
	while((null() != result->innerException)){
		__SAFE_POINT
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/haxe/exception/Exception.hx",93)
		result = result->innerException;
	}
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/haxe/exception/Exception.hx",95)
	return result;
}
...
::String Exception_obj::toString( ){
	...
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/haxe/exception/Exception.hx",98)
