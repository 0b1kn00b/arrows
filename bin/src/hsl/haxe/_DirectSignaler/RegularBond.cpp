...
{
{
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",313)
	super::__construct();
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",314)
...
int RegularBond_obj::callListener( Dynamic data,Dynamic currentTarget,Dynamic origin,int propagationStatus){
	...
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",317)
	if ((false == this->halted)){
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",318)
		this->listener(data);
	}
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",320)
...
bool RegularBond_obj::determineEquals( ::hsl::haxe::_DirectSignaler::LinkedBond value){
	...
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",329)
