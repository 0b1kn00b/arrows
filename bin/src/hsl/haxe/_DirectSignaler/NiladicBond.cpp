...
{
{
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",342)
	super::__construct();
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",343)
...
int NiladicBond_obj::callListener( Dynamic data,Dynamic currentTarget,Dynamic origin,int propagationStatus){
	...
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",346)
	if ((false == this->halted)){
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",347)
		this->listener();
	}
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",349)
...
bool NiladicBond_obj::determineEquals( ::hsl::haxe::_DirectSignaler::LinkedBond value){
	...
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",358)
