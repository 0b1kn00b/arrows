...
{
{
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",371)
	super::__construct();
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",372)
...
int AdvancedBond_obj::callListener( Dynamic data,Dynamic currentTarget,Dynamic origin,int propagationStatus){
	...
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",375)
	if ((this->halted == false)){
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",376)
		::hsl::haxe::Signal signal = ::hsl::haxe::Signal_obj::__new(data,this,currentTarget,origin);
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",377)
		this->listener(signal);
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",378)
		if (signal->immediatePropagationStopped){
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",379)
			return 1;
		}
		else{
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",380)
			if (signal->propagationStopped){
				HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",381)
				return 2;
			}
		}
	}
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",384)
...
bool AdvancedBond_obj::determineEquals( ::hsl::haxe::_DirectSignaler::LinkedBond value){
	...
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",393)
