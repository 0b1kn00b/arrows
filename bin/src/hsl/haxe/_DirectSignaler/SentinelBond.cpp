...
{
{
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",263)
	super::__construct();
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",264)
...
::hsl::haxe::_DirectSignaler::LinkedBond SentinelBond_obj::add( ::hsl::haxe::_DirectSignaler::LinkedBond value){
	...
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",271)
	value->next = this;
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",272)
	value->previous = this->previous;
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",273)
...
int SentinelBond_obj::callListener( Dynamic data,Dynamic currentTarget,Dynamic origin,int propagationStatus){
	...
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",276)
	::hsl::haxe::_DirectSignaler::LinkedBond node = this->next;
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",277)
	while((bool((node != this)) && bool((1 != propagationStatus)))){
		__SAFE_POINT
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",278)
		propagationStatus = node->callListener(data,currentTarget,origin,propagationStatus);
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",279)
		node = node->next;
	}
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",281)
...
bool SentinelBond_obj::getIsConnected( ){
	...
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",289)
...
Void SentinelBond_obj::remove( ::hsl::haxe::_DirectSignaler::LinkedBond value){
{
		...
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",297)
		::hsl::haxe::_DirectSignaler::LinkedBond node = this->next;
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",298)
		while((node != this)){
			__SAFE_POINT
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",299)
			if (node->determineEquals(value)){
				HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",300)
				...
				HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",301)
				break;
			}
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",303)
			node = node->next;
		}
	}
return null();
