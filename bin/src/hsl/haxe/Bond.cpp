...
{
{
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/Bond.hx",47)
	this->halted = false;
}
;
	return null();
...
Void Bond_obj::halt( ){
{
		...
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/Bond.hx",61)
		this->halted = true;
	}
return null();
}
...
Void Bond_obj::resume( ){
{
		...
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/Bond.hx",68)
		this->halted = false;
	}
return null();
}
...
::String Bond_obj::toString( ){
	HX_SOURCE_PUSH("Bond_obj::toString")
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/Bond.hx",72)
	return HX_CSTRING("[Bond]");
}


HX_DEFINE_DYNAMIC_FUNC0(Bond_obj,toString,return )
