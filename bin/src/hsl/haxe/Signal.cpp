...
{
{
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/Signal.hx",137)
	this->__FieldRef(HX_CSTRING("data")) = data;
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/Signal.hx",138)
	this->currentBond = currentBond;
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/Signal.hx",139)
	this->__FieldRef(HX_CSTRING("currentTarget")) = currentTarget;
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/Signal.hx",140)
	this->__FieldRef(HX_CSTRING("origin")) = origin;
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/Signal.hx",144)
	this->immediatePropagationStopped = false;
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/Signal.hx",145)
...
Dynamic Signal_obj::getData( ){
	...
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/Signal.hx",149)
...
Void Signal_obj::stopImmediatePropagation( ){
{
		...
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/Signal.hx",214)
...
Void Signal_obj::stopPropagation( ){
{
		...
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/Signal.hx",227)
...
::String Signal_obj::toString( ){
	HX_SOURCE_PUSH("Signal_obj::toString")
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/Signal.hx",231)
	return (((HX_CSTRING("[GenericSignal data=") + this->__Field(HX_CSTRING("data")))) + HX_CSTRING("]"));
}


HX_DEFINE_DYNAMIC_FUNC0(Signal_obj,toString,return )
