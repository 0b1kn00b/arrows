...
{
{
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",57)
	if ((null() == subject)){
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",58)
		hx::Throw (::haxe::exception::ArgumentNullException_obj::__new(HX_CSTRING("subject"),1));
	}
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",60)
	this->__FieldRef(HX_CSTRING("subject")) = subject;
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",61)
	this->rejectNullData = rejectNullData;
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",62)
...
Void DirectSignaler_obj::addBubblingTarget( ::hsl::haxe::Signaler value){
{
		...
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",65)
		if ((null() == this->bubblingTargets)){
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",66)
			this->bubblingTargets = ::List_obj::__new();
		}
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",68)
...
Void DirectSignaler_obj::addNotificationTarget( ::hsl::haxe::Signaler value){
{
		...
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",71)
		if ((null() == this->notificationTargets)){
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",72)
			this->notificationTargets = ::List_obj::__new();
		}
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",74)
...
::hsl::haxe::Bond DirectSignaler_obj::bind( Dynamic listener){
	...
	struct _Function_1_1{
		inline static ::hsl::haxe::_DirectSignaler::LinkedBond Block( ::hsl::haxe::DirectSignaler_obj *__this,Dynamic &listener){
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",77)
...
::hsl::haxe::Bond DirectSignaler_obj::bindAdvanced( Dynamic listener){
	...
	struct _Function_1_1{
		inline static ::hsl::haxe::_DirectSignaler::LinkedBond Block( ::hsl::haxe::DirectSignaler_obj *__this,Dynamic &listener){
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",80)
			::hsl::haxe::_DirectSignaler::SentinelBond _g = __this->sentinel;
...
::hsl::haxe::Bond DirectSignaler_obj::bindVoid( Dynamic listener){
	...
	struct _Function_1_1{
		inline static ::hsl::haxe::_DirectSignaler::LinkedBond Block( ::hsl::haxe::DirectSignaler_obj *__this,Dynamic &listener){
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",83)
			::hsl::haxe::_DirectSignaler::SentinelBond _g = __this->sentinel;
...
Void DirectSignaler_obj::bubble( Dynamic data,Dynamic origin){
{
		...
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",86)
		if ((null() != this->bubblingTargets)){
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",87)
			for(::cpp::FastIterator_obj< ::hsl::haxe::Signaler > *__it = ::cpp::CreateFastIterator< ::hsl::haxe::Signaler >(this->bubblingTargets->__Field(HX_CSTRING("iterator"))());  __it->hasNext(); ){
				...
				{
					HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",88)
...
;
		...
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",91)
		if ((null() != this->notificationTargets)){
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",92)
			for(::cpp::FastIterator_obj< ::hsl::haxe::Signaler > *__it = ::cpp::CreateFastIterator< ::hsl::haxe::Signaler >(this->notificationTargets->__Field(HX_CSTRING("iterator"))());  __it->hasNext(); ){
				...
				{
					HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",93)
...
Void DirectSignaler_obj::dispatch( Dynamic data,Dynamic origin,Dynamic positionInformation){
{
		...
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",125)
		if ((bool((HX_CSTRING("dispatchNative") != positionInformation->__Field(HX_CSTRING("methodName")).Cast< ::String >())) && bool((HX_CSTRING("bubble") != positionInformation->__Field(HX_CSTRING("methodName")).Cast< ::String >())))){
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",126)
			this->verifyCaller(positionInformation);
		}
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",131)
		if ((bool(this->rejectNullData) && bool((null() == data)))){
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",132)
		...
		struct _Function_1_1{
			inline static Dynamic Block( ::hsl::haxe::DirectSignaler_obj *__this){
				HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",135)
		...
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",137)
		if ((3 == this->sentinel->callListener(data,this->__Field(HX_CSTRING("subject")),origin,3))){
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",138)
			{
				HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",138)
				if ((null() != this->bubblingTargets)){
					HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",138)
...
bool DirectSignaler_obj::getIsListenedTo( ){
	...
	struct _Function_1_1{
		inline static bool Block( ::hsl::haxe::DirectSignaler_obj *__this){
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",142)
			::hsl::haxe::_DirectSignaler::SentinelBond _g = __this->sentinel;
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",142)
			return (_g->next != _g);
		}
...
Dynamic DirectSignaler_obj::getOrigin( Dynamic origin){
	...
	struct _Function_1_1{
		inline static Dynamic Block( ::hsl::haxe::DirectSignaler_obj *__this){
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",150)
			return __this->__Field(HX_CSTRING("subject"));
		}
	};
	struct _Function_1_2{
		inline static Dynamic Block( Dynamic &origin){
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",152)
			return origin;
		}
	};
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",148)
...
Void DirectSignaler_obj::verifyCaller( Dynamic positionInformation){
{
		...
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",168)
		if ((null() == this->subjectClassNames)){
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",169)
			this->subjectClassNames = ::haxe::TypeTools_obj::getClassNames(this->__Field(HX_CSTRING("subject")));
		}
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",171)
		for(::cpp::FastIterator_obj< ::String > *__it = ::cpp::CreateFastIterator< ::String >(this->subjectClassNames->__Field(HX_CSTRING("iterator"))());  __it->hasNext(); ){
			...
			{
				HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",172)
				if ((subjectClassName == positionInformation->__Field(HX_CSTRING("className")).Cast< ::String >())){
					HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",173)
					return null();
				}
			}
;
		...
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",176)
...
Void DirectSignaler_obj::removeBubblingTarget( ::hsl::haxe::Signaler value){
{
		...
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",180)
		if ((null() != this->bubblingTargets)){
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",181)
...
Void DirectSignaler_obj::removeNotificationTarget( ::hsl::haxe::Signaler value){
{
		...
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",185)
		if ((null() != this->notificationTargets)){
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",186)
...
::String DirectSignaler_obj::toString( ){
	__SAFE_POINT
	HX_SOURCE_PUSH("DirectSignaler_obj::toString")
	HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",191)
	return (((HX_CSTRING("[Signaler isListenedTo=") + this->getIsListenedTo())) + HX_CSTRING("]"));
}


HX_DEFINE_DYNAMIC_FUNC0(DirectSignaler_obj,toString,return )

Void DirectSignaler_obj::unbind( Dynamic listener){
{
		__SAFE_POINT
		HX_SOURCE_PUSH("DirectSignaler_obj::unbind")
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",195)
		{
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",195)
...
Void DirectSignaler_obj::unbindAdvanced( Dynamic listener){
{
		...
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",198)
		{
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",198)
			::hsl::haxe::_DirectSignaler::SentinelBond _g = this->sentinel;
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",198)
...
Void DirectSignaler_obj::unbindVoid( Dynamic listener){
{
		...
		HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",201)
		{
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",201)
			::hsl::haxe::_DirectSignaler::SentinelBond _g = this->sentinel;
			HX_SOURCE_POS("../../platform/x/src/hx/hxhsl/hsl-pico source/hsl/haxe/DirectSignaler.hx",201)
