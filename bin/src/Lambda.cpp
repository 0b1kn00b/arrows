...
Array< Dynamic > Lambda_obj::array( Dynamic it){
	...
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",36)
	Array< Dynamic > a = Array_obj< Dynamic >::__new();
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",37)
	for(::cpp::FastIterator_obj< Dynamic > *__it = ::cpp::CreateFastIterator< Dynamic >(it->__Field(HX_CSTRING("iterator"))());  __it->hasNext(); ){
		Dynamic i = __it->next();
		a->push(i);
		__SAFE_POINT
	}
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",39)
	return a;
}
...
::List Lambda_obj::list( Dynamic it){
	...
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",46)
	::List l = ::List_obj::__new();
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",47)
	for(::cpp::FastIterator_obj< Dynamic > *__it = ::cpp::CreateFastIterator< Dynamic >(it->__Field(HX_CSTRING("iterator"))());  __it->hasNext(); ){
		Dynamic i = __it->next();
		l->add(i);
		__SAFE_POINT
	}
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",49)
	return l;
}
...
::List Lambda_obj::map( Dynamic it,Dynamic f){
	...
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",57)
	::List l = ::List_obj::__new();
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",58)
	for(::cpp::FastIterator_obj< Dynamic > *__it = ::cpp::CreateFastIterator< Dynamic >(it->__Field(HX_CSTRING("iterator"))());  __it->hasNext(); ){
		Dynamic x = __it->next();
		l->add(f(x));
		__SAFE_POINT
	}
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",60)
	return l;
}
...
::List Lambda_obj::mapi( Dynamic it,Dynamic f){
	...
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",67)
	::List l = ::List_obj::__new();
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",68)
	int i = 0;
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",69)
	for(::cpp::FastIterator_obj< Dynamic > *__it = ::cpp::CreateFastIterator< Dynamic >(it->__Field(HX_CSTRING("iterator"))());  __it->hasNext(); ){
		Dynamic x = __it->next();
		l->add(f((i)++,x));
		__SAFE_POINT
	}
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",71)
	return l;
}
...
bool Lambda_obj::has( Dynamic it,Dynamic elt,Dynamic cmp){
	...
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",82)
	if ((cmp == null())){
		HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",83)
		for(::cpp::FastIterator_obj< Dynamic > *__it = ::cpp::CreateFastIterator< Dynamic >(it->__Field(HX_CSTRING("iterator"))());  __it->hasNext(); ){
			Dynamic x = __it->next();
			if ((x == elt))
				return true;
		...
		HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",87)
		for(::cpp::FastIterator_obj< Dynamic > *__it = ::cpp::CreateFastIterator< Dynamic >(it->__Field(HX_CSTRING("iterator"))());  __it->hasNext(); ){
			Dynamic x = __it->next();
			if (cmp(x,elt))
				return true;
	...
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",91)
	return false;
}
...
bool Lambda_obj::exists( Dynamic it,Dynamic f){
	...
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",98)
	for(::cpp::FastIterator_obj< Dynamic > *__it = ::cpp::CreateFastIterator< Dynamic >(it->__Field(HX_CSTRING("iterator"))());  __it->hasNext(); ){
		Dynamic x = __it->next();
		if (f(x))
			return true;
	...
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",101)
	return false;
}
...
bool Lambda_obj::foreach( Dynamic it,Dynamic f){
	...
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",108)
	for(::cpp::FastIterator_obj< Dynamic > *__it = ::cpp::CreateFastIterator< Dynamic >(it->__Field(HX_CSTRING("iterator"))());  __it->hasNext(); ){
		Dynamic x = __it->next();
		if (!(f(x)))
			return false;
	...
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",111)
	return true;
}
...
Void Lambda_obj::iter( Dynamic it,Dynamic f){
{
		...
		HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",118)
		for(::cpp::FastIterator_obj< Dynamic > *__it = ::cpp::CreateFastIterator< Dynamic >(it->__Field(HX_CSTRING("iterator"))());  __it->hasNext(); ){
			Dynamic x = __it->next();
			f(x);
			__SAFE_POINT
...
::List Lambda_obj::filter( Dynamic it,Dynamic f){
	...
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",126)
	::List l = ::List_obj::__new();
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",127)
	for(::cpp::FastIterator_obj< Dynamic > *__it = ::cpp::CreateFastIterator< Dynamic >(it->__Field(HX_CSTRING("iterator"))());  __it->hasNext(); ){
		Dynamic x = __it->next();
		if (f(x))
			l->add(x);
	...
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",130)
	return l;
}
...
Dynamic Lambda_obj::fold( Dynamic it,Dynamic f,Dynamic first){
	...
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",137)
	for(::cpp::FastIterator_obj< Dynamic > *__it = ::cpp::CreateFastIterator< Dynamic >(it->__Field(HX_CSTRING("iterator"))());  __it->hasNext(); ){
		Dynamic x = __it->next();
		first = f(x,first);
		__SAFE_POINT
	}
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",139)
	return first;
}
...
int Lambda_obj::count( Dynamic it){
	...
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",146)
	int n = 0;
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",147)
	for(::cpp::FastIterator_obj< Dynamic > *__it = ::cpp::CreateFastIterator< Dynamic >(it->__Field(HX_CSTRING("iterator"))());  __it->hasNext(); ){
		Dynamic _ = __it->next();
		++(n);
		__SAFE_POINT
	}
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",149)
	return n;
}
...
bool Lambda_obj::empty( Dynamic it){
	...
	HX_SOURCE_POS("D:\\stack\\platform\\win\\programs\\Motion-Twin\\haxe/std/Lambda.hx",156)
	return !(it->__Field(HX_CSTRING("iterator"))()->__Field(HX_CSTRING("hasNext"))().Cast< bool >());
}
