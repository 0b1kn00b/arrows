...
#endif
#ifndef INCLUDED_test_arrow_TraceObjectTest
#include <test/arrow/TraceObjectTest.h>
#endif
namespace test{
namespace arrow{
...
{
{
	HX_SOURCE_POS("unit/test/arrow/TraceObjectTest.hx",11)
	super::__construct();
}
;
	return null();
...
Void TraceObjectTest_obj::testTraceArrow( ){
{
		...
		HX_SOURCE_POS("unit/test/arrow/TraceObjectTest.hx",14)
		try{
			HX_SOURCE_POS("unit/test/arrow/TraceObjectTest.hx",15)
			::haxe::Log_obj::trace(::haxe::functional::arrows::Arrow_obj::__new(this->nullMethod_dyn()),hx::SourceInfo(HX_CSTRING("TraceObjectTest.hx"),15,HX_CSTRING("test.arrow.TraceObjectTest"),HX_CSTRING("testTraceArrow")));
		}
		catch(Dynamic __e){
			{
				Dynamic e = __e;{
					HX_SOURCE_POS("unit/test/arrow/TraceObjectTest.hx",17)
					this->fail(null(),hx::SourceInfo(HX_CSTRING("TraceObjectTest.hx"),17,HX_CSTRING("test.arrow.TraceObjectTest"),HX_CSTRING("testTraceArrow")));
				}
			}
		}
	}
...
Void TraceObjectTest_obj::testTraceArrowInstance( ){
{
		...
		HX_SOURCE_POS("unit/test/arrow/TraceObjectTest.hx",21)
		try{
			HX_SOURCE_POS("unit/test/arrow/TraceObjectTest.hx",22)
			::haxe::functional::arrows::ArrowInstance_obj::__new(::haxe::functional::arrows::Arrow_obj::__new(this->nullMethod_dyn()),1);
		}
		catch(Dynamic __e){
			{
				Dynamic e = __e;{
					HX_SOURCE_POS("unit/test/arrow/TraceObjectTest.hx",24)
					this->fail(null(),hx::SourceInfo(HX_CSTRING("TraceObjectTest.hx"),24,HX_CSTRING("test.arrow.TraceObjectTest"),HX_CSTRING("testTraceArrowInstance")));
				}
			}
		}
	}
...
Void TraceObjectTest_obj::nullMethod( Dynamic x,::haxe::functional::arrows::ArrowInstance a){
{
		...
		HX_SOURCE_POS("unit/test/arrow/TraceObjectTest.hx",28)
		return x;
	}
return null();
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("test.arrow.TraceObjectTest"), hx::TCanCast< TraceObjectTest_obj> ,sStaticFields,sMemberFields,
