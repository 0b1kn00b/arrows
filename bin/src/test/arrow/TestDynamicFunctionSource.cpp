...
::test::arrow::TestDynamicFunctionSource TestDynamicFunctionSource_obj::whatAmI( ){
	...
	HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",155)
	return this;
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("test.arrow.TestDynamicFunctionSource"), hx::TCanCast< TestDynamicFunctionSource_obj> ,sStaticFields,sMemberFields,
