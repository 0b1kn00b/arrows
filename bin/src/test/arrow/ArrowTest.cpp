...
{
{
	HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",25)
	super::__construct();
}
;
	return null();
...
{
				__SAFE_POINT
				HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",30)
				::haxe::test::Assert_obj::equals(x,162,null(),null(),hx::SourceInfo(HX_CSTRING("ArrowTest.hx"),30,HX_CSTRING("test.arrow.ArrowTest"),HX_CSTRING("testSimpleArrow")));
			}
			return null();
		}
		HX_END_LOCAL_FUNC1((void))

		HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",28)
		::haxe::functional::arrows::Arrow f3 = ::haxe::functional::arrows::Function1Arrow_obj::tuple(( Dynamic(new _Function_1_1())));
		HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",33)
...
{
				__SAFE_POINT
				HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",39)
				::haxe::test::Assert_obj::equals(x->__Field(HX_CSTRING("productElement"))(0),11,null(),null(),hx::SourceInfo(HX_CSTRING("ArrowTest.hx"),39,HX_CSTRING("test.arrow.ArrowTest"),HX_CSTRING("testPair")));
				HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",40)
				::haxe::test::Assert_obj::equals(x->__Field(HX_CSTRING("productElement"))(1),20,null(),null(),hx::SourceInfo(HX_CSTRING("ArrowTest.hx"),40,HX_CSTRING("test.arrow.ArrowTest"),HX_CSTRING("testPair")));
			}
			return null();
		}
		HX_END_LOCAL_FUNC1((void))

		HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",37)
		::haxe::functional::arrows::Arrow as = ::haxe::functional::arrows::Function1Arrow_obj::tuple( Dynamic(new _Function_1_1()));
		HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",42)
...
{
				__SAFE_POINT
				HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",47)
				::haxe::test::Assert_obj::equals(x->__Field(HX_CSTRING("productElement"))(0),11,null(),null(),hx::SourceInfo(HX_CSTRING("ArrowTest.hx"),47,HX_CSTRING("test.arrow.ArrowTest"),HX_CSTRING("testFirst")));
				HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",48)
				::haxe::test::Assert_obj::equals(x->__Field(HX_CSTRING("productElement"))(1),10,null(),null(),hx::SourceInfo(HX_CSTRING("ArrowTest.hx"),48,HX_CSTRING("test.arrow.ArrowTest"),HX_CSTRING("testFirst")));
			}
			return null();
		}
		HX_END_LOCAL_FUNC1((void))

		HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",45)
		Dynamic as = ::haxe::test::Assert_obj::createEvent( Dynamic(new _Function_1_1()),null());
		HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",51)
...
{
				__SAFE_POINT
				HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",57)
				::haxe::test::Assert_obj::equals(x->__Field(HX_CSTRING("productElement"))(0),10,null(),null(),hx::SourceInfo(HX_CSTRING("ArrowTest.hx"),57,HX_CSTRING("test.arrow.ArrowTest"),HX_CSTRING("testSecond")));
				HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",58)
				::haxe::test::Assert_obj::equals(x->__Field(HX_CSTRING("productElement"))(1),11,null(),null(),hx::SourceInfo(HX_CSTRING("ArrowTest.hx"),58,HX_CSTRING("test.arrow.ArrowTest"),HX_CSTRING("testSecond")));
			}
			return null();
		}
		HX_END_LOCAL_FUNC1((void))

		HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",55)
		Dynamic as = ::haxe::test::Assert_obj::createEvent( Dynamic(new _Function_1_1()),null());
		HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",61)
...
{
				__SAFE_POINT
				HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",66)
				::haxe::test::Assert_obj::equals(11,x->__Field(HX_CSTRING("productElement"))(0),null(),null(),hx::SourceInfo(HX_CSTRING("ArrowTest.hx"),66,HX_CSTRING("test.arrow.ArrowTest"),HX_CSTRING("testFanout")));
				HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",67)
				::haxe::test::Assert_obj::equals(20,x->__Field(HX_CSTRING("productElement"))(1),null(),null(),hx::SourceInfo(HX_CSTRING("ArrowTest.hx"),67,HX_CSTRING("test.arrow.ArrowTest"),HX_CSTRING("testFanout")));
			}
			return null();
		}
		HX_END_LOCAL_FUNC1((void))

		HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",64)
		Dynamic as = ::haxe::test::Assert_obj::createEvent( Dynamic(new _Function_1_1()),null());
		HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",70)
...
{
				__SAFE_POINT
				HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",75)
				::haxe::test::Assert_obj::equals(10,x->__Field(HX_CSTRING("productElement"))(0),null(),null(),hx::SourceInfo(HX_CSTRING("ArrowTest.hx"),75,HX_CSTRING("test.arrow.ArrowTest"),HX_CSTRING("testTie")));
				HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",76)
				::haxe::test::Assert_obj::equals(11,x->__Field(HX_CSTRING("productElement"))(1),null(),null(),hx::SourceInfo(HX_CSTRING("ArrowTest.hx"),76,HX_CSTRING("test.arrow.ArrowTest"),HX_CSTRING("testTie")));
			}
			return null();
		}
		HX_END_LOCAL_FUNC1((void))

		HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",73)
		Dynamic as = ::haxe::test::Assert_obj::createEvent( Dynamic(new _Function_1_1()),null());
		HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",79)
...
{
				__SAFE_POINT
				HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",85)
				::haxe::test::Assert_obj::equals(x->__Field(HX_CSTRING("productElement"))(0),11,null(),null(),hx::SourceInfo(HX_CSTRING("ArrowTest.hx"),85,HX_CSTRING("test.arrow.ArrowTest"),HX_CSTRING("testJoin")));
				HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",86)
				::haxe::test::Assert_obj::equals(x->__Field(HX_CSTRING("productElement"))(1),22,null(),null(),hx::SourceInfo(HX_CSTRING("ArrowTest.hx"),86,HX_CSTRING("test.arrow.ArrowTest"),HX_CSTRING("testJoin")));
			}
			return null();
		}
		HX_END_LOCAL_FUNC1((void))

		HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",83)
		Dynamic as = ::haxe::test::Assert_obj::createEvent( Dynamic(new _Function_1_1()),null());
		HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",89)
...
Void ArrowTest_obj::testRepeat( ){
{
		...
		HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",92)
...
{
				__SAFE_POINT
				HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",95)
				::haxe::test::Assert_obj::equals(num->__get(0),x,null(),null(),hx::SourceInfo(HX_CSTRING("ArrowTest.hx"),95,HX_CSTRING("test.arrow.ArrowTest"),HX_CSTRING("testRepeat")));
			}
			return null();
		}
		HX_END_LOCAL_FUNC1((void))

		HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",93)
...
{
				__SAFE_POINT
				HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",99)
				int out = (x + 1);
				HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",100)
				if ((out < num->__get(0))){
					HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",101)
					return ::haxe::functional::arrows::Arrow_obj::doRepeat(out);
				}
				else{
					HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",103)
		...
		HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",98)
		Dynamic g0 =  Dynamic(new _Function_1_2(num));
		HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",106)
...
{
				__SAFE_POINT
				HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",111)
				::haxe::test::Assert_obj::isTrue(true,null(),hx::SourceInfo(HX_CSTRING("ArrowTest.hx"),111,HX_CSTRING("test.arrow.ArrowTest"),HX_CSTRING("testDelay")));
			}
			return null();
		}
		HX_END_LOCAL_FUNC1((void))

		HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",109)
		Dynamic as = ::haxe::test::Assert_obj::createEvent( Dynamic(new _Function_1_1()),3000);
		HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",114)
...
Void ArrowTest_obj::testReturnA( ){
{
		...
		HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",117)
		::test::arrow::ArrowTest self = this;

		HX_BEGIN_LOCAL_FUNC0(_Function_1_1)
		Void run(::String x){
{
				__SAFE_POINT
				HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",120)
				::haxe::test::Assert_obj::equals(HX_CSTRING("test"),x,null(),null(),hx::SourceInfo(HX_CSTRING("ArrowTest.hx"),120,HX_CSTRING("test.arrow.ArrowTest"),HX_CSTRING("testReturnA")));
			}
			return null();
		}
		HX_END_LOCAL_FUNC1((void))

		HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",118)
		Dynamic as = ::haxe::test::Assert_obj::createEvent( Dynamic(new _Function_1_1()),null());
		HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",123)
...
Dynamic ArrowTest_obj::f0( double x){
	...
	HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",127)
	double out = (x + 1);
	HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",128)
	this->__Field(HX_CSTRING("debug"))(out);
	HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",129)
	return out;
}
...
Dynamic ArrowTest_obj::f1( double x){
	...
	HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",133)
	double out = (x * 2);
	HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",134)
	this->__Field(HX_CSTRING("debug"))(out);
	HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",135)
	return out;
}
...
Dynamic ArrowTest_obj::debug( Dynamic x){
	...
	HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",139)
	return x;
}
...
Dynamic ArrowTest_obj::g( Dynamic x){
	...
	HX_SOURCE_POS("unit/test/arrow/ArrowTest.hx",142)
	return x;
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("test.arrow.ArrowTest"), hx::TCanCast< ArrowTest_obj> ,sStaticFields,sMemberFields,
