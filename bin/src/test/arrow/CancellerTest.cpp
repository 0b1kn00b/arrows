...
#include <test/arrow/CancellerTest.h>
#endif
namespace test{
namespace arrow{
...
{
{
	HX_SOURCE_POS("unit/test/arrow/CancellerTest.hx",18)
	super::__construct();
}
;
	return null();
...
Void CancellerTest_obj::testCanceller( ){
{
		...
		HX_SOURCE_POS("unit/test/arrow/CancellerTest.hx",21)
		Array< ::test::arrow::CancellerTest > self = Array_obj< ::test::arrow::CancellerTest >::__new().Add(this);

		HX_BEGIN_LOCAL_FUNC1(_Function_1_1,Array< ::test::arrow::CancellerTest >,self)
		Void run(Dynamic x){
{
				__SAFE_POINT
				HX_SOURCE_POS("unit/test/arrow/CancellerTest.hx",24)
				self[0]->assertTrue(true,null(),hx::SourceInfo(HX_CSTRING("CancellerTest.hx"),24,HX_CSTRING("test.arrow.CancellerTest"),HX_CSTRING("testCanceller")));
			}
			return null();
		}
		HX_END_LOCAL_FUNC1((void))

		HX_SOURCE_POS("unit/test/arrow/CancellerTest.hx",22)
		Dynamic async = ::haxe::test::Assert_obj::createEvent( Dynamic(new _Function_1_1(self)),null());
		HX_SOURCE_POS("unit/test/arrow/CancellerTest.hx",27)
		::haxe::functional::arrows::Arrow a = ::haxe::functional::arrows::Arrow_obj::delayA(10);
		HX_SOURCE_POS("unit/test/arrow/CancellerTest.hx",28)
		::haxe::functional::arrows::combinators::ProgressArrow b = ::haxe::functional::arrows::Arrow_obj::returnA()->then(a)->run(null());
		HX_SOURCE_POS("unit/test/arrow/CancellerTest.hx",30)
		b->cancel();
		HX_SOURCE_POS("unit/test/arrow/CancellerTest.hx",31)
		::haxe::functional::arrows::Arrow_obj::begin();
		HX_SOURCE_POS("unit/test/arrow/CancellerTest.hx",33)
		::haxe::functional::arrows::Arrow_obj::returnA()->then(::haxe::functional::arrows::Function1Arrow_obj::lift(async))->run(null());
		HX_SOURCE_POS("unit/test/arrow/CancellerTest.hx",35)
		::haxe::functional::arrows::Arrow_obj::begin();
	}
return null();
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("test.arrow.CancellerTest"), hx::TCanCast< CancellerTest_obj> ,sStaticFields,sMemberFields,
