...
#include <test/arrow/FunctionArrowTest.h>
#endif
namespace test{
namespace arrow{
...
{
{
	HX_SOURCE_POS("unit/test/arrow/FunctionArrowTest.hx",20)
	super::__construct();
}
;
	return null();
...
Void FunctionArrowTest_obj::testLift( ){
{
		...
		int run(int x){
{
				HX_SOURCE_POS("unit/test/arrow/FunctionArrowTest.hx",24)
				return (x + 1);
			}
			return null();
		}
		...
		HX_SOURCE_POS("unit/test/arrow/FunctionArrowTest.hx",23)
		Dynamic a =  Dynamic(new _Function_1_1());
		HX_SOURCE_POS("unit/test/arrow/FunctionArrowTest.hx",26)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("test.arrow.FunctionArrowTest"), hx::TCanCast< FunctionArrowTest_obj> ,sStaticFields,sMemberFields,
