...
#define INCLUDED_Function1Extensions

#include <hxcpp.h>

HX_DECLARE_CLASS0(Function1Extensions)


class Function1Extensions_obj : public hx::Object{
	public:
		typedef hx::Object super;
		typedef Function1Extensions_obj OBJ_;
		Function1Extensions_obj();
		Void __construct();

	public:
		static hx::ObjectPtr< Function1Extensions_obj > __new();
		...
		::String __ToString() const { return HX_CSTRING("Function1Extensions"); }
		...
		static Dynamic compose( Dynamic $t1,Dynamic $t2);
		static Dynamic compose_dyn();

		static Dynamic andThen( Dynamic f1,Dynamic f2);
		static Dynamic andThen_dyn();

		static Dynamic lazy( Dynamic $t1,Dynamic $t2);
...
#endif /* INCLUDED_Function1Extensions */ 
