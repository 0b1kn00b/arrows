...
class List_obj : public hx::Object{
	...
	Dynamic &show_dyn() { return show;}
		...
		virtual ::haxe::data::collections::List append( Dynamic b);
		Dynamic append_dyn();
		...
		virtual bool contains( Dynamic t);
		Dynamic contains_dyn();

		virtual ::haxe::data::collections::List add( Dynamic t);
		Dynamic add_dyn();

		virtual ::haxe::data::collections::List addAll( Dynamic i);
		Dynamic addAll_dyn();

		virtual ::haxe::data::collections::List remove( Dynamic t);
		Dynamic remove_dyn();

		virtual ::haxe::data::collections::List removeAll( Dynamic i);
