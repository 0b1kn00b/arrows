...
class Map_obj : public hx::Object{
	...
	Dynamic &valueShow_dyn() { return valueShow;}
		...
		virtual bool isDefinedAt( Dynamic k);
		Dynamic isDefinedAt_dyn();

		virtual ::haxe::functional::PartialFunction1 orElse( ::haxe::functional::PartialFunction1 that);
		Dynamic orElse_dyn();

		virtual ::haxe::functional::PartialFunction1 orAlways( Dynamic f);
		Dynamic orAlways_dyn();

		virtual ::haxe::functional::PartialFunction1 orAlwaysC( Dynamic v);
		Dynamic orAlwaysC_dyn();

		virtual Dynamic call( Dynamic k);
		Dynamic call_dyn();
		...
		virtual ::haxe::data::collections::Map append( ::Tuple2 t);
		Dynamic append_dyn();

		virtual Dynamic foldl( Dynamic z,Dynamic f);
		Dynamic foldl_dyn();

		virtual ::haxe::data::collections::Map set( Dynamic k,Dynamic v);
		Dynamic set_dyn();

		virtual ::haxe::data::collections::Map add( ::Tuple2 t);
		Dynamic add_dyn();

		virtual ::haxe::data::collections::Map addAll( Dynamic i);
		Dynamic addAll_dyn();

		virtual ::haxe::data::collections::Map remove( ::Tuple2 t);
		Dynamic remove_dyn();

		virtual ::haxe::data::collections::Map removeAll( Dynamic i);
		...
		virtual bool contains( ::Tuple2 t);
