...
class Set_obj : public hx::Object{
	...
	Dynamic &show_dyn() { return show;}
		...
		virtual bool contains( Dynamic e);
		Dynamic contains_dyn();

		virtual ::haxe::functional::Foldable empty( );
		Dynamic empty_dyn();

		virtual ::haxe::data::collections::Set append( Dynamic t);
		Dynamic append_dyn();

		virtual Dynamic foldl( Dynamic z,Dynamic f);
		Dynamic foldl_dyn();

		virtual ::haxe::data::collections::Set add( Dynamic t);
		Dynamic add_dyn();

		virtual ::haxe::data::collections::Set addAll( Dynamic it);
		Dynamic addAll_dyn();

		virtual ::haxe::data::collections::Set remove( Dynamic t);
		Dynamic remove_dyn();

		virtual ::haxe::data::collections::Set removeAll( Dynamic it);
