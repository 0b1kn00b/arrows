...
class Arrow_obj : public hx::Object{
	...
	Dynamic &method_dyn() { return method;}
		...
		virtual ::haxe::functional::arrows::combinators::RepeatThunk forever( );
		Dynamic forever_dyn();
		...
		static ::haxe::functional::arrows::combinators::EventArrow eventA( ::String trigger);
		static Dynamic eventA_dyn();

		static ::haxe::functional::arrows::combinators::SignalArrow signalA( );
		static Dynamic signalA_dyn();
