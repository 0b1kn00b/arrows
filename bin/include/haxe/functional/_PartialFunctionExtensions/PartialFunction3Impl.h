...
class PartialFunction3Impl_obj : public hx::Object{
	...
	public:
		...
		virtual bool isDefinedAt( Dynamic _tmp_a,Dynamic _tmp_b,Dynamic _tmp_c);
		Dynamic isDefinedAt_dyn();

		virtual ::haxe::functional::PartialFunction3 orElse( ::haxe::functional::PartialFunction3 _tmp_that);
		Dynamic orElse_dyn();

		virtual ::haxe::functional::PartialFunction3 orAlways( Dynamic _tmp_f);
		Dynamic orAlways_dyn();

		virtual ::haxe::functional::PartialFunction3 orAlwaysC( Dynamic _tmp_$t1);
		Dynamic orAlwaysC_dyn();

		virtual Dynamic call( Dynamic _tmp_a,Dynamic _tmp_b,Dynamic _tmp_c);
		Dynamic call_dyn();
