...
class PartialFunction4Impl_obj : public hx::Object{
	...
	public:
		...
		virtual bool isDefinedAt( Dynamic a,Dynamic b,Dynamic c,Dynamic d);
		Dynamic isDefinedAt_dyn();

		virtual ::haxe::functional::PartialFunction4 orElse( ::haxe::functional::PartialFunction4 that);
		Dynamic orElse_dyn();

		virtual ::haxe::functional::PartialFunction4 orAlways( Dynamic f);
		Dynamic orAlways_dyn();

		virtual ::haxe::functional::PartialFunction4 orAlwaysC( Dynamic $t1);
		Dynamic orAlwaysC_dyn();

		virtual Dynamic call( Dynamic a,Dynamic b,Dynamic c,Dynamic d);
		Dynamic call_dyn();
