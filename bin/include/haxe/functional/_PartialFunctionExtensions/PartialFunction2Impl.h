...
class PartialFunction2Impl_obj : public hx::Object{
	...
	public:
		...
		virtual bool isDefinedAt( Dynamic _tmp_a,Dynamic _tmp_b);
		Dynamic isDefinedAt_dyn();

		virtual ::haxe::functional::PartialFunction2 orElse( ::haxe::functional::PartialFunction2 _tmp_that);
		Dynamic orElse_dyn();

		virtual ::haxe::functional::PartialFunction2 orAlways( Dynamic _tmp_f);
		Dynamic orAlways_dyn();

		virtual ::haxe::functional::PartialFunction2 orAlwaysC( Dynamic _tmp_$t1);
		Dynamic orAlwaysC_dyn();

		virtual Dynamic call( Dynamic _tmp_a,Dynamic _tmp_b);
		Dynamic call_dyn();
