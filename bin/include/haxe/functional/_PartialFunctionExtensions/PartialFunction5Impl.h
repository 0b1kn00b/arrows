...
class PartialFunction5Impl_obj : public hx::Object{
	...
	public:
		...
		virtual bool isDefinedAt( Dynamic a,Dynamic b,Dynamic c,Dynamic d,Dynamic e);
		Dynamic isDefinedAt_dyn();

		virtual ::haxe::functional::PartialFunction5 orElse( ::haxe::functional::PartialFunction5 that);
		Dynamic orElse_dyn();

		virtual ::haxe::functional::PartialFunction5 orAlways( Dynamic f);
		Dynamic orAlways_dyn();

		virtual ::haxe::functional::PartialFunction5 orAlwaysC( Dynamic $t1);
		Dynamic orAlwaysC_dyn();

		virtual Dynamic call( Dynamic a,Dynamic b,Dynamic c,Dynamic d,Dynamic e);
		Dynamic call_dyn();
