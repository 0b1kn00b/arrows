...
class EventScheduler extends AbstractScheduler {
	...
	override public function start():Void {
		...
		state = "waiting";
		#if (js)
			untyped window.setTimeout("haxe.reactive.arrow.blaze.AbstractScheduler.self.start()",100);
		#elseif (flash9)
			untyped (__global__["flash.utils.setTimeout"])(haxe.reactive.arrow.blaze.AbstractScheduler.self.start, 100);
		#elseif flash
			var me = this;
			untyped _global["setTimeout"](haxe.reactive.arrow.blaze.AbstractScheduler.self.start, 100);
		#end
	}
}